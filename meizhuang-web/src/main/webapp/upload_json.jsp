 ...
 */
 ...
 String saveRootpath = SystemParameterUtils.get(SystemParameterEnum.FILE_SAVE_ROOT_PATH);
//文件保存目录路径
String savePath = saveRootpath + "/attached/";

//文件保存目录URL
String saveUrl  = request.getContextPath() + "/getFile/attached/";
...
for(Map.Entry<String, List<FileItem>> mitem : items.entrySet()){
    List<FileItem> fileItems = mitem.getValue();
	...
	while (itr.hasNext()) {
		...
		if (!item.isFormField()) {
			...
			out.println(obj.toJSONString(4));
		}
	}
}
%>
