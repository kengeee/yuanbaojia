...
<title>鉴别_${SYSTEM_SITE_NAME}</title>
<meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,user-scalable=0,width=device-width">
<meta http-equiv="Cache-Control" content="no-siteapp">
<meta name="format-detection" content="telephone=no">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-title" content="鉴别_${SYSTEM_SITE_NAME}">
...
<div class="head-bar-title">鉴别</div>
...
<div style="width: 95%;margin: 0 auto; text-align: center; font-weight: bold">
    ...
    <c:forEach items="${identify_list}" var="item" >
		<div style="margin-top: 10px">
			${item.title}
		</div>
		<a href="${item.url}"><img alt="" src="/getFile/identify/${item.qrcodeImg}/" style="max-width: 230px"></a>
    </c:forEach>
