...
<meta charset="UTF-8">
<title>搜索结果_${SYSTEM_SITE_NAME}-${SYSTEM_SITE_DESC}</title>
<meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,user-scalable=0,width=device-width">
<meta http-equiv="Cache-Control" content="no-siteapp">
<meta name="format-detection" content="telephone=no">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-title" content="搜索结果_${SYSTEM_SITE_NAME}-${SYSTEM_SITE_DESC}">
...
.reach{width:96%;margin:20px auto}
...
.reach-btn{float:left;margin-top: 2px;width: 29%;height:44px;border:0;color:#fff;
  ...
  <div class="contentBody">
	<div id="head-bar">
		<div class="head-bar">
			...
			<img src="/static/images/icon-back.png" width="24" height="24">
			</a>
			</div>
	...
	<table id="data_table" cellspacing="0" style="display: table;">
       ...
       <c:forEach var="group" items="${productGroupList}">
       		<tr class="goods bg_pro" data-goods_type="1" data-gid="11901" data-sid="99708">
	            ...
	            <td class="shop">
	                <a href="/dangkou_goods?gate=${group.uid}&random=${group.random}">
	            		<div>${group.storeName}</div>
            ...
            <td class="data_action" colspan="4">
                ...
                <button class="ui red button btn_copy" style="display: none">复制</button>
            </td>
       	 </tr>
       </c:forEach>
...
<ul>
 <c:if test="${empty productGroupList}">
       	
       	<li style="line-height:20px;height:50px;text-align:center;">暂时没有找到你要的产品，我们在努力收集中，感谢你的关注!</li>
	
 </c:if>
<li style="line-height:20px;height:20px;text-align:center;color:#bbb;">我是有底线的</li>
</ul>
</div>
...
jQuery(function($){
	...
	$('.wx').click(function(){
		...
		if(wxImg != ''){
			...
			"<br>长按二维码图片加好友"+
			"<br>"+
			"<img src='/getFile/"+wxImg+"/"+''+"' width='220' heigth='220'/>";
		}
