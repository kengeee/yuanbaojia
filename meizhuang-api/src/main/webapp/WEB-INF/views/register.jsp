...
<title>用户注册_${SYSTEM_SITE_NAME}</title>
<meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,user-scalable=0,width=device-width">
<meta http-equiv="Cache-Control" content="no-siteapp">
<meta name="format-detection" content="telephone=no">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-title" content="用户注册_${SYSTEM_SITE_NAME}">
...
<div class="head-bar-title">用户注册</div>
...
<div class="box notranslate">
  <form action="${HOME_DOMAIN_NAME}/registerDo" method="post" enctype="multipart/form-data" >
    <div class="public_box">
   
     <table class="user_info">
     	<tr>
     	<td class="item_tip">手机号:</td>
     	<td class="item_text"><input class="public_inputtxt" placeholder="手机号" id="user_name" name="phone" value="${phone}">
     	</td>
     	</tr>
     	<tr>
     	<td class="item_tip">密码:</td>
     	<td class="item_text"><input class="public_inputtxt" placeholder="密码" id="user_pwd" type="password" name="pwd" value="${pwd}">
     	</td>
     	</tr>
     	<tr>
     	<td class="item_tip">确认密码:</td>
     	<td class="item_text"><input class="public_inputtxt" placeholder="确认密码" id="user_pwd2" type="password" name="pwd2" value="${pwd2}">
     	</td>
     	</tr>
     	<tr>
     	<td class="item_tip">微信账号:</td>
     	<td class="item_text"><input class="public_inputtxt" placeholder="微信账号" id="weixin2"  name="weixin" value="${weixin}">
        </td>
     	</tr>
     	<tr>
     	...
     	<td class="item_text"><input class="public_inputtxt" placeholder="店名" id="storeName"  name="storeName" value="${storeName}">
        </td>
     	</tr>
     	<tr>
     	...
     	<td class="item_text"><input class="public_inputtxt" placeholder="国家+地区+市场+档口号" id="tradeStall"  name="tradeStall" value="${tradeStall}">
        </td>
     	</tr>
     </table>
        <button class="public_btn register common_style_red">注册</button>
...
<script type="text/javascript">
	...
	<div style="text-align: center;">
	  	<div style="margin: 10px">商家入驻请扫码联系客服</div>
	  <img alt="" src="${HOME_DOMAIN_NAME}/static/images/my/reg_wx.png" width="300" height="300">
	</div>
